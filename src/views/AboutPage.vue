...
const content = computed(() => lang.value === 'sv' ? {
    ...
    tiles: [
        ...
        { icon: '📡', title: 'Realtidsdata', text: 'Officiell data från Trafiklab. Visar max 20 avgångar inom 2 timmar. Realtid visas i blått.' },
    ...
    tiles: [
        ...
        { icon: '📡', title: 'Real-time data', text: 'Official data from Trafiklab. Shows up to 20 departures within the next 2 hours. Real-time shown in blue.' },
