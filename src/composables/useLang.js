...
const strings = {
  sv: {
    ...
    welcomeHero:  'Se snabbt och smidigt kommande avgångstider på dina valda hållplatser.',
  ...
  en: {
    ...
    welcomeHero:  'Quickly and easily see upcoming departure times for your selected stops.',
